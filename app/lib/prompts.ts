...
Note: Text within double curly braces will have several variations generated by another text model according to the instructions inside the braces, using text before the colon (if it exists) as an example. For example: "{{sunset: vary time of day}}" may become "sunset", "afternoon", or "morning". If these these constructs exist in the original prompt, they should be carried through in your improved prompt. You are encouraged to improve the instructions within to be more descriptive, for example "{{sunset with the sun visible in the background: vary time of day with notes on lighting}}.
